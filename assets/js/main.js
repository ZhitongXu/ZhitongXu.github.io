...
function blog_posts() {
    ...
    let posts = [
        {
            url: 'https://mp.weixin.qq.com/s/UUqjx3GCSrDiVkZ3jUC9Jw',
            title: 'Take part in the competition of musical instrument group',
        },
        {
        ...
        },
        {
            ...
            title: 'Volunteer at DoraHacks x Binance Defi Hackathon@Beijing',
        },
    ];
